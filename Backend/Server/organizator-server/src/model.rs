...
pub struct FilestoreResult<'a> {
    pub db_only: Vec<&'a FilestoreFileDB>,
    pub dir_only: Vec<FilestoreFile>,
}
...
/// This macro generates types for utoipa
macro_rules! response_with_requester {
    ($struct_name:ident, $field_name:ident, $data_type:ty) => {
...
// TODO adapt the macro to use the Named trait to automatically generate the field name.
// Automatically generates structs with #[derive(Serialize, ToSchema)]
